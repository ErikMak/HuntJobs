...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 03 2022 г., 22:49
...
INSERT INTO `resumes` (`id`, `user_id`, `full_name`, `age`, `exp`, `education`, `requirements`) VALUES
(1, 2, 'Test User Profile', '20 лет', '3 года', 'Высшее', 'Уютный офис недалеко от дома');
...
(2, 'User', 1, 'test2@gmail.com', '9bc43b811fa686ee21575d045e7d6800', 'Не указан');
